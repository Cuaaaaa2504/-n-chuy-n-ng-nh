          ...
          <div key={booking.bookingId} className="card-item booking-card">
            ...
            <div className="card-body">
              ...
              <div className="card-row">
                ...
                <span className="card-value">{booking.movieTitle}</span>
              </div>
              <div className="card-row">
                <span className="card-label">Suất chiếu:</span>
                <span className="card-value">{booking.showtime}</span>
              </div>
              <div className="card-row">
                <span className="card-label">Ghế:</span>
                <span className="card-value">{booking.seats.join(', ')}</span>
              </div>
              <div className="card-row">
                <span className="card-label">Tổng tiền:</span>
                <span className="card-value amount">{formatCurrency(booking.totalAmount)}</span>
              </div>
            </div>
          </div>
        ))}
