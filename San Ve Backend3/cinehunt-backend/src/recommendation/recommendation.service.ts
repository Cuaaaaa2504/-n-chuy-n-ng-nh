...
type UpstreamSource = 'MODEL' | 'CACHE' | 'POPULARITY' | 'UNKNOWN';
...
export class RecommendationService {
  ...
  async getRecommendationsForUser(
    ...
    const upstream = await this.fetchRecommendationsFromModel(
      userId,
      safeLimit,
    );
  ...
  private parseSource(payload: unknown): UpstreamSource {
  ...
  private toPublicSource(source: UpstreamSource): RecommendationSource {
